...
The remainder of the manuscript is organized as follows. Section \ref{sec:relatedwork} reviews related work; Section \ref{sec:methodology} describes dataset preparation and model implementations; Section \ref{sec:results} presents quantitative and qualitative results; Section \ref{sec:discussion} discusses implications, limitations and future directions; and Section \ref{sec:conclusions} concludes.
